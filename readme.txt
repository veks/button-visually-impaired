...
= Плагин bvi v1.0.5 включает в себя: =
...
* Плагин активировать через ` меню WordPress ` > Плагины > bvi v1.0.5 > Активировать`.
* Перейдите bvi v1.0.5 и в настройках `включите плагин`.
...
* WordPress plugin is activated ` Menu > Plugins > bvi v1.0.5 > Activate`.
* Go bvi v1.0.5 and is configured to `include a plugin`.
